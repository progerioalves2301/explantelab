...
BEGIN
  ...
  UPDATE public.bancadas
     SET status = COALESCE(_status, status),
         ...
         rtc_verificando = COALESCE(_rtc_verificando, rtc_verificando),
         sensor_travado = CASE
